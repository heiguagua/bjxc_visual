...
<div class="longin_content">
    ...
    <div class="bottom_cont" id="country">
        <form class="form-horizontal" id="fromid" action="<%=context_path%>/login/doLogin" data-validator-option="{theme:'bootstrap', timely:2, theme:'simple_bottom'}" method="post">
            ...
            <div id ="loginerror" class="alert alert-danger alert-dismissible" style="display: none">
                <h4 style="margin-bottom: 0px;"><i class="fa fa-exclamation-triangle"></i><span id="loginerror-message"></span></h4>
            </div>
            ...
            <c:if test="${identifyCodeOpen}">
                <div class="inputdiv reg-box">
                    <div style="width:409px;display:inline-block" id="captchaDiv">
                        <div class="has-feedback mg">
                            <input type="text" class="form-control input_test" id="captcha" name="captcha" placeholder="验证码" data-rule="验证码:required;length(5);" size="5">
            ...
            <div class="inputdiv">
                <button class="login_subtn" id="loaded" type="button">登&emsp;录</button>
            </div>
        </form>
    </div>
</div>
