...
<head>
    ...
    <script src="<%=basePath%>/js/dir/configure/policy/policyEdit.js"></script>
</head>
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    <form role="form" data-validator-option="{theme:'bootstrap', timely:2, stopOnError:true}" method="post" action="<%=basePath%>/dirPolicy/doEdit">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label>类型</label>
                                <div id='Etype-group' class="btn-group">
