...
<head>
    ...
    <script src="/js/dir/configure/specialapp/specialappEdit.js"></script>
</head>
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    <form role="form" data-validator-option="{theme:'bootstrap', timely:2, stopOnError:true}" method="post" action="/dirSpecialApps/doEdit">
