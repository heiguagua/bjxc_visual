...
<head>
    ...
    <script src="<%=context_path%>/js/dir/configure/home/homeList.js"></script>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="form-inline">
                            <div class="box-header">
                                ...
                                <div class="input-group pull-right">
                                    <input id="searchKeyId" type="text" name="search" class="form-control" placeholder="请输入名称">
                        ...
                        <div class="box-body table-responsive">
                            <table id="dirHomeTableId" class="table table-hover">
