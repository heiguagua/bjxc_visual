...
<head>
    ...
    <script src="<%=context_path%>/js/system/productIntegrate/productIntegrateEdit.js"></script>
</head>
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    <form class="form-horizontal"  role="form" data-validator-option="{theme:'bootstrap', timely:2, stopOnError:true}" method="post" action="<%=context_path%>/system/productIntegrate/doEdit">
