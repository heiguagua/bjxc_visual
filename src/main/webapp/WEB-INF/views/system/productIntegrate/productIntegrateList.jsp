...
<head>
    ...
    <script src="<%=context_path%>/js/system/productIntegrate/productIntegrateList.js"></script>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box-body table-responsive">
                                <table id="productIntegrateTableId" class="table table-hover">
