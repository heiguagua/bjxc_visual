...
<head>
    ...
    <script src="/js/system/userAuthority/userAuthorityEdit.js"></script>
</head>
...
<section class="content" style="padding-top:0">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    <form role="form" data-validator-option="{theme:'bootstrap', timely:2, stopOnError:true}" method="post" action="/system/userAuthority/doEdit">
