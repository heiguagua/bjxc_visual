...
<head>
    ...
    <link rel="stylesheet" href="<%=context_path%>/plugins/bootstrap-fileinput/css/fileinput.min.css">
    <script src="<%=context_path%>/js/system/me/changePassword.js"></script>
    <style>
        .file-drop-zone{
            height:auto;
        }
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                <div class="row">
                                    <div class="col-md-6">
                                        <form role="form" id="imgUpload" data-validator-option="{theme:'bootstrap', timely:2, stopOnError:true}" method="post" action="<%=context_path%>/system/me/uploadImage" enctype="multipart/form-data">
                                            <div class="box-body">
...
<script src="<%=context_path%>/plugins/bootstrap-fileinput/js/fileinput.min.js"></script>
<script src="<%=context_path%>/plugins/bootstrap-fileinput/js/locales/zh.js"></script>
<script>
...
<!--
<script src="<%=context_path%>/js/page.js"></script>
-->
</body>
</html>
