...
<head>
    ...
    <script src="<%=context_path%>/js/system/setting/settingEdit.js"></script>
</head>
            ...
            <div class="row">
                <div class="col-md-6">
                    <form role="form" data-validator-option="{theme:'bootstrap', timely:2, stopOnError:true}"
                          method="post" action="<%=context_path%>/system/setting/doEdit">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="settingValue" name="settingValue" class="form-control"
                                       placeholder="请输入系统配置值" data-rule="组织系统配置值:length[1~300, true];">
                            </div>
                            <div class="form-group">
