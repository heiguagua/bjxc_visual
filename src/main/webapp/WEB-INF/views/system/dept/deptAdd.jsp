            ...
            <div class="row">
                <div class="col-md-6">
                    <form role="form" data-validator-option="{theme:'bootstrap', timely:2, stopOnError:true}"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div id="fname" name="fname"  class="col-sm-3">
                                    <select class="form-control">
                                        <option value="">--请选择--</option>
                                        <option value="">四川高级人民法院</option>
                                        <option value="">湖南财会厅</option>
                                        <option value="">陕西公安厅</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <span class="radio-inline">
	                      <input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="0">启用
	                    </span>
                                    <span class="radio-inline">
	                      <input type="radio" name="inlineRadioOptions" id="inlineRadio3" value="1" checked>停用
	                    </span>
                                </div>
                            </div>
