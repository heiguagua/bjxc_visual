...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    <form role="form" data-validator-option="{theme:'bootstrap', timely:2, stopOnError:true}" method="post" action="<%=basePath%>/system/dept/doEdit">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="deptName" name="deptName" class="form-control" placeholder="请输入组织机构名称"
                                       data-rule="组织机构名称:required;simpleName;remote(<%=basePath%>/system/dept/checkDeptName?deptId=${deptId});">
                            </div>
                            <div class="form-group">
