                    ...
                    <form role="form" data-validator-option="{theme:'bootstrap', timely:2, stopOnError:true}"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="regionCode" style='float:left;'
                                       class="col-sm-3 control-label">所属行政区域</label>
                                <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                <label for="validateFrom" style='float:left;'
                                       class="col-sm-3 control-label">组织启用时间</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="validateFrom" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="validateTo" style='float:left;'
                                       class="col-sm-3 control-label">组织停用时间</label>
                                <div class="col-sm-7">
