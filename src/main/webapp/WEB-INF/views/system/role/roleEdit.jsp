...
<head>
    ...
    <script src="<%=context_path%>/js/system/role/roleEdit.js"></script>
     <style>
        .form-group{
            margin-bottom:25px;
        }
            ...
            <div class="row">
                <div class="col-md-6">
                    <form class="form-inline"  role="form" data-validator-option="{theme:'bootstrap', timely:2, stopOnError:true}"
                          method="post" action="<%=context_path%>/system/role/doEdit">
                        ...
                        <div class="box-body box-bodyx">
                            <div class="form-group">
                                ...
                                <input type="text" id="roleName" name="roleName" class="form-control"
                                       placeholder="请输入角色名称" data-rule="角色名称:simpleName;required;remote(<%=context_path%>/system/role/checkRoleName?roleId=${roleId});">
                                </div>
                            </div>
                            <div class="form-group">
                                <label>角色描述</label>
