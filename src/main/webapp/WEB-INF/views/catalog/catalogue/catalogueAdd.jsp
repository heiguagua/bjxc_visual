                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="belongDeptName" disabled>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="col-sm-9">
                                <div class="col-sm-6" style="padding:0">
                                    <select class="form-control" data-rule="所属资源格式:required;" id="format_category" name="ext.format_category">
                                    </select>
                                </div>
                                <div class="col-sm-6" style="padding:0">
