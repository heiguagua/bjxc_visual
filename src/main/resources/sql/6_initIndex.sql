...
-- 先删除所有的索引
call del_idx('p_dir','dir_classify','Index_dirclassify_classifycode');
...
call del_idx('p_dir','dir_data_collection','Index_dirdatacollection_dcmid');
call del_idx('p_dir','dir_data_comment','Index_dirdatacomment_dcmid');
call del_idx('p_dir','dir_data_correction','Index_dirdatacorrection_dcmid');
call del_idx('p_dir','dir_data_offline','Index_dirdataoffline_dcmid');
call del_idx('p_dir','dir_data_publish','Index_dirdatapublish_dcmid');
call del_idx('p_dir','dir_data_rate','Index_dirdatarate_dcmid');
call del_idx('p_dir','dir_data_registe','Index_dirdataregiste_dcmid');
call del_idx('p_dir','dir_data_visit','Index_dirdatavisit_dcmid');
call del_idx('p_dir','dir_data_visit','Index_dirdatavisit_visitip');
call del_idx('p_dir','dir_dataitem','Index_dirdataitem_datasetid');
call del_idx('p_dir','dir_dataitem','Index_dirdataitem_itemname');
call del_idx('p_dir','dir_data_item_apply','Index_dirdataitemapply_dataapplyid');
call del_idx('p_dir','dir_data_item_apply','Index_dirdataitemapply_itemid');
call del_idx('p_dir','dir_dataitem_source_info','Index_dirdataitemsourceinfo_itemid');
call del_idx('p_dir','dir_dataitem_source_info','Index_dirdataitemsourceinfo_sourceitemid');
call del_idx('p_dir','dir_dataset','Index_dirdataset_datasetcode');
call del_idx('p_dir','dir_dataset','Index_dirdataset_datasetname');
call del_idx('p_dir','dir_dataset','Index_dirdataset_belongdeptid');
call del_idx('p_dir','dir_dataset_classify_map','Index_dirdatasetclassifymap_datasetid');
call del_idx('p_dir','dir_dataset_classify_map','Index_dirdatasetclassifymap_classifyid');
call del_idx('p_dir','dir_dataset_classify_map','Index_dirdatasetclassifymap_inforesourcecode');
call del_idx('p_dir','dir_dataset_ext_format','Index_dirdatasetextformat_datasetid');
call del_idx('p_dir','dir_dataset_service_map','Index_dirdatasetservicemap_serviceid');
call del_idx('p_dir','dir_dataset_service_map','Index_dirdatasetservicemap_objid');
call del_idx('p_dir','dir_dataset_source_info','Index_dirdatasetsourceinfo_datasetid');
call del_idx('p_dir','dir_dataset_source_info','Index_dirdatasetsourceinfo_sourceobjid');
call del_idx('p_dir','dir_dataset_source_relation','Index_dirdatasetsourcerelation_datasetid');
call del_idx('p_dir','dir_dataset_source_relation','Index_dirdatasetsourcerelation_sourcetableid');
call del_idx('p_dir','dir_dataset_source_relation','Index_dirdatasetsourcerelation_sourcecolumnid');
call del_idx('p_dir','dir_dataset_source_relation','Index_dirdatasetsourcerelation_targettableid');
call del_idx('p_dir','dir_dataset_source_relation','Index_dirdatasetsourcerelation_targetcolumnid');
call del_idx('p_dir','dir_news','Index_dirnews_title');
call del_idx('p_dir','dir_policy','Index_dirpolicy_title');
call del_idx('p_dir','dir_regist_user','Index_dirregistuser_loginname');
call del_idx('p_dir','dir_regist_user','Index_dirregistuser_realname');
call del_idx('p_dir','sys_dept','Index_sysdept_deptcode');
call del_idx('p_dir','sys_dept','Index_sysdept_deptname');
call del_idx('p_dir','sys_dept','Index_sysdept_deptshortname');
call del_idx('p_dir','sys_dept','Index_sysdept_fid');
call del_idx('p_dir','sys_dept_authority','Index_sysdeptauthority_authobjid');
call del_idx('p_dir','sys_dept_authority_apply','Index_sysdeptauthorityapply_applicant');
call del_idx('p_dir','sys_dept_contacts','Index_sysdeptcontacts_curdeptid');
call del_idx('p_dir','sys_dict','Index_sysdict_dictcode');
call del_idx('p_dir','sys_dict','Index_sysdict_parentcode');
call del_idx('p_dir','sys_guid_dept','Index_sysguiddept_curdeptid');
call del_idx('p_dir','sys_guid_dept','Index_sysguiddept_guiddeptid');
call del_idx('p_dir','sys_log','Index_syslog_operatorid');
call del_idx('p_dir','sys_region','Index_sysregion_regioncode');
call del_idx('p_dir','sys_region','Index_sysregion_fcode');
call del_idx('p_dir','sys_region_dept','Index_sysregiondept_regiondeptcode');
call del_idx('p_dir','sys_region_dept','Index_sysregiondept_fcode');
call del_idx('p_dir','sys_region_dept','Index_sysregiondept_structurecode');
call del_idx('p_dir','sys_role_menu','Index_sysrolemenu_roleid');
call del_idx('p_dir','sys_role_menu','Index_sysrolemenu_menuid');
call del_idx('p_dir','sys_user','Index_sysuser_username');
call del_idx('p_dir','sys_user','Index_sysuser_realname');
call del_idx('p_dir','sys_user_role','Index_sysuserrole_userid');
call del_idx('p_dir','sys_user_role','Index_sysuserrole_roleid');
call del_idx('p_dir','drap_activity_doc_item','Index_drapactivitydocitem_docid');
call del_idx('p_dir','drap_activity_doc_map','Index_drapactivitydocmap_activityid');
call del_idx('p_dir','drap_activity_doc_map','Index_drapactivitydocmap_docid');
call del_idx('p_dir','drap_activity_rel_depts','Index_drapactivityreldepts_activityid');
call del_idx('p_dir','drap_activity_rel_depts','Index_drapactivityreldepts_deptid');
call del_idx('p_dir','drap_activity_set_map','Index_drapactivitysetmap_datasetid');
call del_idx('p_dir','drap_activity_set_map','Index_drapactivitysetmap_activityid');
call del_idx('p_dir','drap_activity_system_map','Index_drapactivitysystemmap_activityid');
call del_idx('p_dir','drap_activity_system_map','Index_drapactivitysystemmap_systemid');
call del_idx('p_dir','drap_business_activity','Index_drapbusinessactivity_belongdept');
call del_idx('p_dir','drap_business_activity','Index_drapbusinessactivity_activityname');
call del_idx('p_dir','drap_business_doc','Index_drapbusinessdoc_belongdept');
call del_idx('p_dir','drap_business_doc','Index_drapbusinessdoc_docname');
call del_idx('p_dir','drap_business_requirement','Index_drapbusinessrequirement_requredeptid');
call del_idx('p_dir','drap_business_requirement','Index_drapbusinessrequirement_sourcedeptid');
call del_idx('p_dir','drap_data_column_map','Index_drapdatacolumnmap_datasetid');
call del_idx('p_dir','drap_data_column_map','Index_drapdatacolumnmap_businessitemid');
call del_idx('p_dir','drap_data_column_map','Index_drapdatacolumnmap_systemcolumnid');
call del_idx('p_dir','drap_data_column_map','Index_drapdatacolumnmap_infosystemid');
call del_idx('p_dir','drap_data_column_map','Index_drapdatacolumnmap_dbid');
call del_idx('p_dir','drap_data_column_map','Index_drapdatacolumnmap_tableid');
call del_idx('p_dir','drap_dataset','Index_drapdataset_belongdepttype');
call del_idx('p_dir','drap_dataset','Index_drapdataset_belongdeptid');
call del_idx('p_dir','drap_dataset','Index_drapdataset_belongactivityid');
call del_idx('p_dir','drap_dataset','Index_drapdataset_datasetname');
call del_idx('p_dir','drap_dataset','Index_drapdataset_datasetcode');
call del_idx('p_dir','drap_dataset_item','Index_drapdatasetitem_itemname');
call del_idx('p_dir','drap_dataset_item_map','Index_drapdatasetitemmap_datasetid');
call del_idx('p_dir','drap_dataset_item_map','Index_drapdatasetitemmap_itemid');
call del_idx('p_dir','drap_dataset_system_map','Index_drapdatasetsystemmap_datasetid');
call del_idx('p_dir','drap_dataset_system_map','Index_drapdatasetsystemmap_systemid');
call del_idx('p_dir','drap_db_info','Index_drapdbinfo_belongdept');
call del_idx('p_dir','drap_db_info','Index_drapdbinfo_dbname');
call del_idx('p_dir','drap_db_info','Index_drapdbinfo_dbcnname');
call del_idx('p_dir','drap_db_system_map','Index_drapdbsystemmap_dbid');
call del_idx('p_dir','drap_db_system_map','Index_drapdbsystemmap_infosystemid');
call del_idx('p_dir','drap_db_table_column','Index_drapdbtablecolumn_tableid');
call del_idx('p_dir','drap_db_table_column','Index_drapdbtablecolumn_columnenname');
call del_idx('p_dir','drap_db_table_column','Index_drapdbtablecolumn_columncnname');
call del_idx('p_dir','drap_db_table_info','Index_drapdbtableinfo_dbid');
call del_idx('p_dir','drap_db_table_info','Index_drapdbtableinfo_tablename');
call del_idx('p_dir','drap_db_table_info','Index_drapdbtableinfo_tablecnname');
call del_idx('p_dir','drap_dict_table_column','Index_drapdicttablecolumn_tableid');
call del_idx('p_dir','drap_dict_table_column','Index_drapdicttablecolumn_columncnname');
call del_idx('p_dir','drap_dict_table_column','Index_drapdicttablecolumn_columnenname');
call del_idx('p_dir','drap_dict_table_info','Index_drapdicttableinfo_dbid');
call del_idx('p_dir','drap_dict_table_info','Index_drapdicttableinfo_tablename');
call del_idx('p_dir','drap_dict_table_info','Index_drapdicttableinfo_tablecnname');
call del_idx('p_dir','drap_info_system','Index_drapinfosystem_belongdept');
call del_idx('p_dir','drap_info_system','Index_drapinfosystem_systemcode');
call del_idx('p_dir','drap_info_system','Index_drapinfosystem_systemname');
call del_idx('p_dir','drap_item_required_dept','Index_drapitemrequireddept_itemid');
call del_idx('p_dir','drap_item_required_dept','Index_drapitemrequireddept_deptid');
call del_idx('p_dir','drap_requirement_dataset_map','Index_draprequirementdatasetmap_requireid');
call del_idx('p_dir','drap_requirement_dataset_map','Index_draprequirementdatasetmap_datasetid');
call del_idx('p_dir','drap_requirement_resources','Index_draprequirementresources_requireid');
call del_idx('p_dir','drap_requirement_resources','Index_draprequirementresources_docid');
call del_idx('p_dir','drap_system_use_dept','Index_drapsystemusedept_systemid');
call del_idx('p_dir','drap_system_use_dept','Index_drapsystemusedept_deptid');
call del_idx('p_dir','drap_system_use_info','Index_drapsystemuseinfo_infosystemid');
