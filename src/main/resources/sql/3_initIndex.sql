...
call del_idx('dsp_dir','dir_dataset_classify_map','Index_dirdatasetclassifymap_datasetid'); -- info_resource_code);
call del_idx('dsp_dir','dir_dataset_classify_map','Index_dirdatasetclassifymap_classifyid'); -- info_resource_code);
...
call del_idx('dsp_dir','dir_news','Index_dirnews_title'); -- title);
...
call del_idx('dsp_dir','drap_dataset_system_map','Index_drapdatasetsystemmap_datasetid'); -- dataset_id, system_id);
call del_idx('dsp_dir','drap_dataset_system_map','Index_drapdatasetsystemmap_systemid'); -- dataset_id, system_id);
...
ALTER TABLE sys_dept ADD INDEX Index_sysdept_deptname (tree_code, dept_name);
ALTER TABLE sys_dept ADD INDEX Index_sysdept_deptshortname (dept_short_name);
ALTER TABLE sys_dept ADD INDEX Index_sysdept_fid (fid);
ALTER TABLE sys_dept ADD INDEX Index_sysdept_treeCode_deptName (tree_code, dept_name);
...
ALTER TABLE sys_role ADD INDEX Index_sys_role_id_delete (`id`, `delete_flag`);
ALTER TABLE sys_role_menu ADD INDEX Index_sysrolemenu_roleid_menuid (role_id,menu_id);
ALTER TABLE sys_setting ADD INDEX Index_syssetting_settingtype (setting_type);
