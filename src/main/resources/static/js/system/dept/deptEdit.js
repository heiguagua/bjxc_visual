            ...
            if(data && data.content && data.content.vo){
                ...
                $.each(items, function(index, value) {
                    ...
                    $("#dataitemList").append('<tr id="tr_'+index+'">' +
                        ...
                        '<td><input type="text" class="form-control"  name="items['+index+'].contactsPost" data-rule="length(~18)" value="'+value.contactsPost+'"></td>' +
                        '<td><input type="text" class="form-control"  name="items['+index+'].contactsFixedPhone" data-rule="tel" value="'+value.contactsFixedPhone+'"></td>' +
                        '<td><input type="text" class="form-control"  name="items['+index+'].contactsPhone" data-rule="mobile" value="'+value.contactsPhone+'"></td>' +
                        '<td><input type="text" class="form-control"  name="items['+index+'].contactsEmail" data-rule="email" value="'+value.contactsEmail+'"></td>' +
                        '</tr>')
                });
            }
        }
