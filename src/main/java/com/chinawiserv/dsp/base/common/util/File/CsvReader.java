...
public class CsvReader {
	...
	/**
	 * Creates a {@link com.chinawiserv.dcm.core.util.csv.CsvReader CsvReader} object using a file
	 * as the data source.
	 * 
	 * @param fileName
	...
	/**
	 * Constructs a {@link com.chinawiserv.dcm.core.util.csv.CsvReader CsvReader} object using a
	...
	/**
	 * Constructs a {@link com.chinawiserv.dcm.core.util.csv.CsvReader CsvReader} object using an
	 ...
	 * {@link com.chinawiserv.dcm.core.util.csv.CsvReader#readHeaders readHeaders()}.
	 *
	...
	/**
	 * Creates a {@link com.chinawiserv.dcm.core.util.csv.CsvReader CsvReader} object using a string
	 * of data as the source.&nbsp;Uses ISO-8859-1 as the
	 * {@link java.nio.charset.Charset Charset}.
	 *
	 * @param data
	 *            The String of data to use as the source.
	 * @return A {@link com.chinawiserv.dcm.core.util.csv.CsvReader CsvReader} object using the
	 ...
	 * increment
	 * {@link com.chinawiserv.dcm.core.util.csv.CsvReader#getCurrentRecord getCurrentRecord()}.
	 *
