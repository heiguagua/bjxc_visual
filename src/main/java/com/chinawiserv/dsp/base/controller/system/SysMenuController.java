...
public class SysMenuController extends BaseController {
	...
	@RequiresPermissions("system:menu:vm")
	@RequestMapping("/forVm")
	public String initForVmList(@RequestParam Map<String, Object> paramMap) {
		setCurrentMenuInfo(paramMap);
		return "system/menu/menuForVm";
	}
	 ...
	 */
	@RequiresPermissions("system:menu:add")
	@RequestMapping("/addForVm")
	public String addForVm() {
		return "system/menu/menuAddForVm";
	 ...
	 * @Log("新增菜单")
	 * 
	 * @RequestMapping("/doAddDir") public String doAddDir(SysMenuVo sysMenu,Model
	 * model){
	 * 
	 * sysMenu.setPid("0"); sysMenu.setMenuType(1); sysMenuService.insert(sysMenu);
