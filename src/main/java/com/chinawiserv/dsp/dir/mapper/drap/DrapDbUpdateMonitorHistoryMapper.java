 ...
 * @since 2017-09-27
 */
public interface DrapDbUpdateMonitorHistoryMapper extends BaseMapper<DrapDbUpdateHistory> {
    ...
    int baseInsert(DrapDbUpdateHistory entity);

    int baseUpdate(DrapDbUpdateHistory entity);
