...
//    }
    ...
    private String getClassifyId(Row row, Map<String, String> hashMap) {
        ...
        String string1 = null;
        try {
            string1 = row.getCell(0).getStringCellValue().trim();
        } catch (Exception e) {
        ...
        String string2 = null;
        try {
            string2 = row.getCell(1).getStringCellValue().trim();
        } catch (Exception e) {
        ...
        String string3 = null;
        try {
            string3 = row.getCell(2).getStringCellValue().trim();
        } catch (Exception e) {
