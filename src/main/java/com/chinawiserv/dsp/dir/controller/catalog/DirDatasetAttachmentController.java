...
import com.chinawiserv.dsp.base.common.bean.response.HandleResult;
import com.chinawiserv.dsp.base.common.bean.response.PageResult;
...
public class DirDatasetAttachmentController extends BaseController {
    ...
    @Autowired
    private IDirDatasetAttachmentService service;
...
//    @RequiresPermissions("XXX:XXX:list")
    ...
    @ResponseBody
    public HandleResult doAdd(DirDatasetAttachmentVo entity){
		HandleResult handleResult = new HandleResult();
		try {
		    service.insertVO(entity);
		    handleResult.success("创建成功");
		} catch (Exception e) {
		    handleResult.error("创建失败");
		    logger.error("创建失败", e);
		}
		return handleResult;
    }
    ...
    public  HandleResult editLoad(@RequestParam String id){
		HandleResult handleResult = new HandleResult();
		try {
            DirDatasetAttachmentVo vo = service.selectVoById(id);
		    handleResult.put("vo", vo);
		} catch (Exception e) {
		    handleResult.error("获取信息失败");
    ...
    @ResponseBody
    public  HandleResult doEdit(DirDatasetAttachmentVo entity,Model model){
		HandleResult handleResult = new HandleResult();
		try {
		    service.updateVO(entity);
		    handleResult.success("编辑成功");
		} catch (Exception e) {
		    handleResult.error("编辑失败");
		    logger.error("编辑失败", e);
		}
		return handleResult;
    }
