 ...
 */
@Controller
@RequestMapping("/DrapDb")
public class DrapDbController {
    @Autowired
    private DrapDbMapper drapDbMapper;
    ...
    public HandleResult selectDbByDeptId(@RequestParam String dept_id) {
        ...
        if (StringUtils.isEmpty(dept_id)) {
            ...
            List<Map<String, Object>> maps = drapDbMapper.selectDbByDeptId(dept_id);
    ...
    public HandleResult selectTableByDbId(@RequestParam String db_id) {
        ...
        if (StringUtils.isEmpty(db_id)) {
            ...
            List<Map<String, Object>> maps = drapDbMapper.selectTableByDbId(db_id);
            handleResult.put("list",maps);
        }
        return handleResult;
    }
    ...
    public HandleResult selectFieldByTableId(@RequestParam String table_id) {
        ...
        if (StringUtils.isEmpty(table_id)) {
            ...
            List<Map<String, Object>> maps = drapDbMapper.selectFieldByTableId(table_id);
            handleResult.put("list",maps);
        }
        return handleResult;
    }
